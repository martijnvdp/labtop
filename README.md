...
| applications | n/a | <pre>object({<br>    cert-manager       = optional(bool, true)<br>    game2048           = optional(bool, true)<br>    grafana            = optional(bool, true)<br>    kube-state-metrics = optional(bool, true)<br>    labtop-info        = optional(bool, true)<br>  })</pre> | `{}` | no |
